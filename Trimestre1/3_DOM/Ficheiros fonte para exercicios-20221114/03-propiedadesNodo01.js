...
console.log(document.body.getElementsByTagName("label")[3].innerHTML);
let tamanho = document.body
  .getElementsByTagName("form")[0]
  .getElementsByTagName("label").length;
console.log(
  document.body.getElementsByTagName("form")[0].getElementsByTagName("label")[
    tamanho - 1
  ].innerHTML
);

//● O textContent da etiqueta anterior
console.log(document.body.getElementsByTagName("label")[3].textContent);
console.log(
  document.body.getElementsByTagName("form")[0].getElementsByTagName("label")[
    tamanho - 2
  ].textContent
...
console.log(
  document.body
    ...
    [tamanho - 1].getElementsByTagName("input")[0].value
);
// ● O valor do sexo que estea seleccionado.
let inputs = document.body
  .getElementsByTagName("form")[0]
  .getElementsByTagName("label")
  [tamanho - 1].getElementsByTagName("input");
